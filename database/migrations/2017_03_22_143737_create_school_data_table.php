...
class CreateSchoolDataTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('school_data', function (Blueprint $table) {
            ...
            $table->string('engAddress')->comment('學校英文地址');
            $table->string('organization')->comment('學校負責僑生事務的承辦單位名稱');
            $table->string('engOrganization')->comment('學校負責僑生事務的承辦單位英文名稱');
            $table->string('dormInfo')->comment('宿舍說明');
            $table->string('engDormInfo')->comment('宿舍英文說明');
            $table->string('url')->comment('學校網站網址');
            $table->string('engUrl')->comment('學校英文網站網址');
            ...
            $table->string('scholarshipUrl')->nullable()->comment('僑生專屬獎學金說明網址');
            $table->string('engScholarshipUrl')->nullable()->comment('僑生專屬獎學金英文說明網址');
            $table->string('scholarshipDept')->comment('獎學金負責單位名稱');
            $table->string('engScholarshipDept')->comment('獎學金負責單位英文名稱');
